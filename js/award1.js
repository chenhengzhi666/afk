$(function () {
    ...
    let nickname = '';
    let count = 0;
    let countMax = 1; //单人可玩次数
    let gameState = 1; //0：活动暂未开放	1：活动正常开发
    let activityStart = '2018-11-23'; //活动开始时间
    let activityEnd = '2018-12-23'; //活动结束时间
    ...
    let wxShare = (appid, str, ticket) => {
        ...
        wx.ready(function () {
            // 微信分享的数据
            var shareData = {
                "imgUrl": 'http://suxiaozhi.tunnel.qydev.com/img/mn.gif', // 分享显示的缩略图地址
                "link": 'http://suxiaozhi.tunnel.qydev.com/afk', // 分享地址
